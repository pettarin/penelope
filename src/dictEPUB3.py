...
class dictEPUB3:
    ...
    def outputIndexPage(self, indexReferences, title, tmpDir):
        ...
        #Python2#        sOUT = sOUT.encode("utf-8")
        #Python3#
        sOUT = str(sOUT)
    ...
    def usage(self):
        print("")
        #Python2#        print("$ python dictEPUB.py words language")
        #Python3#
        print("$ python3 dictEPUB3.py words language")
        print("")
        ...
        print("")
        print("Examples:")
        #Python2#        print(" $ python dictEPUB.py words.txt en")
        #Python3#
        print(" $ python3 dictEPUB3.py words.txt en")
